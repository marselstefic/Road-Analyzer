...
export default function SensorScreen({ route }) {
  ...
  const DEFAULT_UPDATE_INTERVAL = 500; // Default to a slower speed
  ...
  const _subscribe = async () => {
    ...
    Accelerometer.setUpdateInterval(DEFAULT_UPDATE_INTERVAL);
    Gyroscope.setUpdateInterval(DEFAULT_UPDATE_INTERVAL);
  };
